...
public class PostController {
    ...
    @ResponseBody
    public String createAd(@RequestParam("post_title") String title, @RequestParam("post_body") String description){
    ...
    @ResponseBody
    public String updateAd(@PathVariable Long id,@RequestParam("post_title") String title, @RequestParam("post_body") String description){
